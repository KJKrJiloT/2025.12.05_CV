  ...
  \cventry
    ...
    {Mar. 2023 - Feb. 2026} % Date(s)
    {
      ...
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Characterized \underline{light-induced charging effects} of oxide patches based on Surface Photovoltage (SPV) theory on trap electrodes and their impact on the ion-trapping potential} \textbf{\textit{(manuscript in preparation)}}
