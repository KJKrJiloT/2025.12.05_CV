...
\begin{itemize}[leftmargin=3.0em, itemsep=0.0em, topsep=-0.0 mm]
    ...
    \item Figure~\ref{fig:figure2}(c) shows the overall cryogenic ion trap experiment, including the fluorescence imaging system with a high-gain EMCCD camera, the vacuum pumping system for maintaining the ultra-high-vacuum (UHV) environment, the helical resonator connected to the RF signal generator for stable high-Q RF delivery, the ablation loading system with a pulsed laser and calcium target, and the laser stabilization system.
