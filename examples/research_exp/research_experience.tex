...
\begin{itemize}[leftmargin=3.0em, itemsep=0.0em, topsep=-0.0cm]
    ...
    \item Laser-cut the alumina substrate using a picosecond laser, deposited a Ti adhesion layer and Au seed layer by sputtering, and electroplated Au to form the electrodes. The fabricated multi-layer chip is shown in Fig.~\ref{fig:figure1}(b).
\end{itemize}
